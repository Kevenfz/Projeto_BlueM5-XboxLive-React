export const games = [
  ...
  },
  {
    ...
    description:
      "Forza Horizon 5 é um videogame de corrida ambientado em um ambiente de mundo aberto baseado em uma representação fictícia do México. O jogo possui o maior mapa de toda a série Forza Horizon, sendo 50% maior que seu antecessor, Forza Horizon 4, além de ter o ponto mais alto da série Horizon.",
    year: "27/09/2016",
    score: 5,
    traillerYtUrl: "https://www.youtube.com/watch?v=FYH9n37B7Yw",
    GplayYtUrl: "https://www.youtube.com/watch?v=d_20X1YM28U",
  },
  {
    ...
    description:
      "Red Dead Redemption 2 é o jogo de ação no Velho Oeste da Rockstar para PS4 e Xbox One, sem lançamento para PC, lançamento em 26 de outubro de 2018. Com modo online parecido com o de GTA 5, Red Dead Online permite completar missões e ganhar dinheiro com outros jogadores.",
    year: "24/10/2018",
    score: 5,
